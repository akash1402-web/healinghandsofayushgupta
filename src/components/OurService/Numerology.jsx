    ...
    return (
        <div className='w-full lg:flex lg:justify-between lg:px-[40px] lg:mt-[200px] mt-[100px]'>
            ...
            <div className='lg:block hidden'>
                ...
                <Link to="/numerology"> <button className='px-[40px] py-[13px] bg-[#8777D7] w-max rounded-lg text-white font-bold lg:mt-[69px] mx-auto lg:mx-0 mt-5'>Calculate Your Birth Number</button></Link>
            </div>
            ...
            <div className='sm:flex hidden lg:hidden flex-col'>
                <p className='mt-[20px] font-sans  text-xl text-center'>We cannot deny the significance of numbers in our lives. Every person’s name is associated with such numbers and numerology is the science that helps us synchronizing our Root number, Soul urge number and destiny number with our Name, and Date of birth. Vibrations of certain numbers are favourable similarly vibrations of certain numbers are unfavourable, which determines our destiny and fortune and correcting these numbers balance these vibrations and energies make us more efficient and helps us become the best version of ourselves.
                </p>
            ...
            <Link to="/numerology"> <button className=' px-[60px] py-[13px] bg-[#8777D7] w-max rounded-lg text-white font-bold  mx-auto  lg:hidden block mt-24'>Calculate Your Birth Number</button></Link>
        </div>
    )
}
