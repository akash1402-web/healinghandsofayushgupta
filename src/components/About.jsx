...
const About = () => {
    return (
        <div className='w-full md:px-[82px] px-[20px] md:gap-40 justify-between flex flex-col md:flex-row items-center md:mt-20 '>
            ...
            <div className='flex flex-col gap-10 justify-center md:flex-1 md:mt-0 mt-5'>
                <h1 className='text-center md:text-4xl font-bold text-2xl md:font-normal'>About</h1>
