...
const Service = () => {
    return (
        <div className='flex w-full mt-20 px-[40px] gap-10 md:flex-row flex-col'>
            <h1 className='text-center md:text-4xl font-bold text-2xl md:font-normal md:hidden'>Our Services</h1>
